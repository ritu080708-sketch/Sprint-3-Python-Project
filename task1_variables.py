...
for i in range(len(video_game_sales)):
    k=k+1
    total_global_sales = total_global_sales + video_game_sales[i][9]
avg_global_sales = total_global_sales/k
print(f"avg_global_sales: {avg_global_sales}")
top_game_share = video_game_sales[0][9]/total_global_sales*100
