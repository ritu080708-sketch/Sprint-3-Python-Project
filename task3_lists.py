...
# 2. Loop through each row (game) in your dataset
for row in video_game_sales:
    # Append the item at column index 1 directly to the list
    game_names.append(row[1])

# 3. Print the finalized list
print(game_names)
game_sales= [21, 'Animal Crossing: New Horizons', 'NS', 2020, 'Simulation', 'Nintendo', 7.45, 5.21, 7.37, 31.18]
video_game_sales.append(game_sales)
